...
- **Edge DB / heavy Node work in middleware** — keep middleware thin; DB access belongs in **Node** runtimes (see **`@multitenant/database`** + [Getting started](/docs/guide/getting-started) Edge note).
...
- [Configuration](/docs/guide/config)
- [Errors](/docs/errors)
