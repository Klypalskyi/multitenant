...
For **shared** **`TenantRegistry`** in middleware **and** Route Handlers / Server Actions, use an explicit **`createTenantRegistry`** module instead of **`auto`** — see [Next.js (App Router)](/frameworks/next-app).

## Next steps

- [Getting started](/getting-started) — **`multitenant dev`** proxy
- [CLI](/cli/dev-check-print)
