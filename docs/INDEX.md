...
- **[Docs site (Nextra, first-class)](https://github.com/klypalskyi/multitenant/tree/master/apps/site)** — human-readable guides + examples (**`/getting-started`**, **`/config`**, **`/frameworks/*`**, **`/examples`**, …); local: `npm run site:dev`. Deploy: Vercel **Root Directory** `apps/site`.
