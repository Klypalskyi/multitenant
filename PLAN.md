...
**Last reviewed:** 2026-03-29 — **Marketing site + CI:** **`apps/site`** (**Nextra 4** / **`nextra-theme-docs`**, [shuding/nextra-docs-template](https://github.com/shuding/nextra-docs-template) lineage); **Vercel** Git deploy (**Root Directory** `apps/site`, **`vercel.json`**); **npm** via **`.github/workflows/publish-npm.yml`** (see **`docs/RELEASE.md`** §7). Dashboard **Website** row **Shipped**. *(Prior: **Phase 2** **v0.6.19**.)*
